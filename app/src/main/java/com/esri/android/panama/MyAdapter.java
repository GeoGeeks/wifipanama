...
public class MyAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (segment.contains("izquierda")) {
            myImage.setImageResource(R.drawable.nav_left);

        } else if (segment.contains("derecha")) {
            myImage.setImageResource(R.drawable.nav_right);

        } else if (segment.contains("Continúe") || segment.contains("avance")
                || segment.contains("Avance")) {
            myImage.setImageResource(R.drawable.nav_straight);

        } else if (segment.contains("Cambie de sentido")) {
