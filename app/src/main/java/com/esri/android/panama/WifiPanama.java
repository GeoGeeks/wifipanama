...
public class WifiPanama  extends ActionBarActivity implements RoutingListFragment.onDrawerListSelectedListener,
            ...
            public void onSingleTap(float x, float y) {
                if (map.isLoaded()) {
                    ...
                    if (progressDialog == null || !progressDialog.isShowing())
                        progressDialog = ProgressDialog.show(map.getContext(), "", "Cargando...");
    ...
    private void QueryDirections(final Point mLocation, final Point p) {
        ...
        dialog = ProgressDialog.show(WifiPanama.this, "Rutas",
    ...
    void updateUI() {
        ...
        if (mResults == null) {
            Toast.makeText(WifiPanama.this, mException.toString(),
    ...
    private class PopupDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(600,600);
            ...
            Button bt1 = new Button(layout.getContext());
            bt1.setText("Ruta");
            bt1.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if(gps) {
                        ...
                        Toast.makeText(getApplicationContext(), "Active su GPS para realizar la ruta.",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            });
